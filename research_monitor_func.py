...
#         10: 4, 11: 4, 12: 4,
#     }
#     this_quarter = month2quarter.get(this_month)
#     if this_quarter == 1:
#         text = str(this_year-1) + "Q4"
#     else:
#         text = str(this_year) + "Q" + str(this_quarter-1)
#     return text
#
# def get_last_sec_quarter(date):
#     this_year = date.year
#     this_month = date.month
#     month2quarter = {
#         1: 1, 2: 1, 3: 1,
...
#     this_quarter = month2quarter.get(this_month)
#     if this_quarter == 1:
#         text = str(this_year-1) + "Q3"
#     elif this_quarter == 2:
#         text = str(this_year-1) + "Q4"
#     else:
#         text = str(this_year) + "Q" + str(this_quarter-2)
#     return text
#
# def get_last_quarter_with_hyphen(date):
#     this_year = date.year
#     this_month = date.month
#     month2quarter = {
#         1: 1, 2: 1, 3: 1,
...
#     return text
#
# def get_last_quarter_with_underline(date):
#     this_year = date.year
#     this_month = date.month
#     month2quarter = {
#         1: 1, 2: 1, 3: 1,
...
#     this_quarter = month2quarter.get(this_month)
#     if this_quarter == 1:
#         text = str(this_year-1) + "_Q4"
#     else:
#         text = str(this_year) + "_Q" + str(this_quarter-1)
#     return text
#
# def get_last_sec_quarter_with_underline(date):
#     this_year = date.year
#     this_month = date.month
#     month2quarter = {
#         1: 1, 2: 1, 3: 1,
...
#     this_quarter = month2quarter.get(this_month)
#     if this_quarter == 1:
#         text = str(this_year-1) + "_Q3"
#     elif this_quarter == 2:
#         text = str(this_year-1) + "_Q4"
#     else:
#         text = str(this_year) + "_Q" + str(this_quarter-2)
#     return text
